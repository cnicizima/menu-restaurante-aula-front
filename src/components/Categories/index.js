...
export default function Categories(props) {
  ...
  return (
    <section className={styles.categories}>
      ...
      <button
        onClick={props.onClickSobremesas}
